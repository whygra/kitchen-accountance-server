...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/whygra/Work/webdev/KitchenAccountance/server/public/storage' => 'string',
...
'app.aliases.View','app.aliases.Vite','app.client_url','auth.defaults.guard','auth.defaults.passwords',
...
'filesystems.links./home/whygra/Work/webdev/KitchenAccountance/server/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'sanctum.csrf-cookie','login','password.email',
...
'validation.uuid','validation.custom.attribute-name.rule-name','validation.attached','validation.relatable',);
        registerArgumentsSet('env', 
'SUPERUSER_NAME','SUPERUSER_PASSWORD','SUPERUSER_EMAIL','APP_NAME','APP_ENV',
'APP_KEY','APP_DEBUG','APP_TIMEZONE','APP_URL','CLIENT_URL',
