...
Route::get('/ingredient-categories/with-ingredients/all', [IngredientCategoryController::class, 'index_loaded']);
Route::get('/ingredient-categories/with-ingredients/{id}', [IngredientCategoryController::class, 'show_loaded']);
...
Route::delete('/ingredient-categories/delete/{id}', [IngredientCategoryController::class, 'destroy']);

Route::get('/ingredients/with-products/all', [IngredientController::class, 'index_loaded']);
Route::get('/ingredients/primary/with-products/{id}', [IngredientController::class, 'show_loaded_primary']);
Route::get('/ingredients/secondary/with-products/{id}', [IngredientController::class, 'show_loaded_secondary']);
