...
class IngredientsProductsSheet implements FromCollection, WithTitle, WithMapping
{
    private $project_id;
    ...
    */
    public function map($ingredient_product): array
    {
        return [
            [
                ...
                $ingredient_product->gross_weight,
                $ingredient_product->net_weight,
    ...
    {
        return ProjectExport::INGREDIENTS_PRODUCTS_SHEET_TITLE;
    }
}