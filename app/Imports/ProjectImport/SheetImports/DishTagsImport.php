...
class DishTagsImport implements ToCollection, WithValidation, WithUpserts, WithSkipDuplicates, SkipsEmptyRows
{
    use Importable;
    ...
    public function model(array $row)
    {
        ...
        $item = $project->dish_tags()->where('name', $row[0])->firstOrNew();
