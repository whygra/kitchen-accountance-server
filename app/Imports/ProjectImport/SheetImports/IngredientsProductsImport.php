...
class IngredientsProductsImport implements ToCollection, WithValidation, WithSkipDuplicates, WithUpserts, SkipsEmptyRows
{
    use Importable;
    ...
    public function model(array $row)
    {
        ...
        $ingredient->products()->attach(
            $product, [
                ...
                // 'waste_percentage' => 100-($net_weight/$gross_weight * 100),
            ]
        );
