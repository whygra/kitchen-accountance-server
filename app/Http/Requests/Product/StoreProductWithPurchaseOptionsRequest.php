...
class StoreProductWithPurchaseOptionsRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'name'=>'required|string|max:60|unique:products,name',

            'category.id'=>'required',
            'category.name'=>'exclude_unless:category.id,0',
