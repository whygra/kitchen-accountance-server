...
class UpdateIngredientCategoryWithIngredientsRequest extends ChecksPermissionsRequest
{
     ...
     */
     ...
     public function rules(): array
     {
         return array_merge(
             ...
             IngredientCategoryRules::getUpdateIngredientCategoryRules($this->id, $this->project_id),
